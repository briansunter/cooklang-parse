 ...
 */
function extractInlineIngredient(text: string, startPos: number): { ingredient: CanonicalIngredient; endPos: number } | null {
...
function convertStepToCanonical(step: Step): CanonicalStepItem[] {
  ...
  const allItems: Array<{ type: string; start: number; data: CanonicalIngredient | CanonicalCookware | CanonicalTimer }> = [];
